...
[![MCP Server Demo](https://img.shields.io/badge/🚀_Demo-Live-blue?style=for-the-badge)](https://github.com/rokoss21/FACET/tree/main/examples/mcp)
[![Performance](https://img.shields.io/badge/⚡_Performance-3.7x_faster-red?style=for-the-badge)](https://github.com/rokoss21/FACET#performance)
[![WebSocket](https://img.shields.io/badge/🌐_Transport-WebSocket-green?style=for-the-badge)](https://github.com/rokoss21/FACET#architecture)
...
**Example Use Case:**
```python
# AI Agent delegates complex data processing
result = await mcp.call_tool("execute", {
    "facet_source": """
...
**Example Use Case:**
```python
# AI Agent cleans messy user input
cleaned = await mcp.call_tool("apply_lenses", {
    "input_string": "   Messy   user   input   ",
    "lenses": ["trim", "squeeze_spaces", "normalize_newlines"]
})
# Result: "Messy user input" (guaranteed!)
```
...
**Example Use Case:**
```python
# AI Agent validates generated response
validation = await mcp.call_tool("validate_schema", {
    "json_object": generated_response,
    "json_schema": required_format_schema
})
# Result: {"valid": true, "errors": null} or detailed error report
```
...
### **Step 1: Install**
```bash
# Install FACET with MCP server
pip install facet-lang[server]

# Or from source
git clone https://github.com/rokoss21/FACET.git
cd FACET && pip install -e .[server]
```
...
# Run tests
cd tests/mcp_server && python run_tests.py
```
...
- **[Getting Started Guide](examples/mcp/)** - Step-by-step tutorials
- **[API Reference](server/facet_mcp/README.md)** - Complete API documentation
- **[Configuration Guide](server/facet_mcp/config/)** - Advanced configuration options
- **[Performance Tuning](tests/mcp_server/)** - Optimization guides
...
```bash
python examples/mcp/demo_server.py
```

#### **Complex Workflow Agent**
```python
# See examples/mcp/usage_examples.py for complete workflows
from examples.mcp.usage_examples import MCPUsageExamples
...
- **📖 [Documentation](server/facet_mcp/README.md)** - Complete technical documentation
- **💬 [GitHub Discussions](https://github.com/rokoss21/FACET/discussions)** - Community support
- **🐛 [Issues](https://github.com/rokoss21/FACET/issues)** - Bug reports and feature requests
